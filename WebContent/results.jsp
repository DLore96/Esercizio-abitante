...
<body>
	<table class="center">
		...
		<% List<Abitante> listaDaServlet = (List<Abitante>)request.getAttribute("listAbitantiAttributeName");
				...
				<tr>
					...
					<td>
						...
						<a href="PrepareUpdateServlet?idDaInviareComeParametro=<%=abitanteItem.getIdAbitante() %>">Modifica</a>
		...
		<tr>
			<td>
				<a href="PrepareInsertServlet">inserisci nuovo utente</a>
			</td>
			<td>
				<a href="PrepareDeleteAbitanteServlet">elimina utente esistente</a>
			</td>
		</tr>
